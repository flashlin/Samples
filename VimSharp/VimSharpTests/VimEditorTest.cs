...
namespace VimSharpTests
{
    ...
    public class VimEditorTest
    {
        ...
        private void InitializeEditor(string text)
        {
            ...
            _editor.Context.SetViewPort(0, 0, 40, 10, _editor.CalculateLineNumberWidth());
        ...
        {
            _editor.SetText(text);
            _editor.Context.SetViewPort(1, 1, 40, 10, _editor.CalculateLineNumberWidth());
            _editor.Mode = new VimNormalMode { Instance = _editor };
        }
        ...
        public void WhenInVisualMode_PressA_ThenPressEsc_CursorShouldMoveBackOnePositionCase2()
        {
            ...
            _editor.Context.SetViewPort(10, 1, 40, 10, _editor.CalculateLineNumberWidth());
        ...
        public void WhenPress10J_CursorShouldJumpToLine10()
        {
            ...
            // 設置視口
            _editor.Context.SetViewPort(0, 0, 40, 5, _editor.CalculateLineNumberWidth());
        ...
        public void WhenStatusBarVisible_PressDownArrow_CursorShouldStopAtLastVisibleLine()
        {
            ...
            // 設置 ViewPort 
            _editor.Context.SetViewPort(0, 1, 40, 5, _editor.CalculateLineNumberWidth());
