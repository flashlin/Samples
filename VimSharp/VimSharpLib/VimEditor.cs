...
public class VimEditor
{
    ...
    /// </summary>
    public void SetCursorPositionAndAdjustViewport(int textX, int textY)
    {
        // 計算行號區域寬度
