...
1. 🟢 DDL（DROP/TRUNCATE/ALTER TABLE/CREATE VIEW/CREATE INDEX 已完成）：`CREATE PROCEDURE|FUNCTION|TRIGGER`、`DROP INDEX ... ON table` 變體、ALTER TABLE 第二階段（見 §1.5）
