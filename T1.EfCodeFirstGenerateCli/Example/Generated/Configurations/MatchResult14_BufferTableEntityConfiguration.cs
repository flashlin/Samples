...
namespace Generated
{
    public class MatchResult14_BufferTableEntityConfiguration : IEntityTypeConfiguration<MatchResult14_BufferTableEntity>
    {
        public void Configure(EntityTypeBuilder<MatchResult14_BufferTableEntity> builder)
        {
            builder.ToTable("MatchResult14_BufferTable");
