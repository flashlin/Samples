...
namespace Generated
{
    public class PTEffectiveEntityConfiguration : IEntityTypeConfiguration<PTEffectiveEntity>
    {
        public void Configure(EntityTypeBuilder<PTEffectiveEntity> builder)
        {
            builder.ToTable("PTEffective");
