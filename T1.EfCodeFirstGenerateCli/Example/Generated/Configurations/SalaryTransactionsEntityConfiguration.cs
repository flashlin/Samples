...
namespace Generated
{
    public class SalaryTransactionsEntityConfiguration : IEntityTypeConfiguration<SalaryTransactionsEntity>
    {
        public void Configure(EntityTypeBuilder<SalaryTransactionsEntity> builder)
        {
            builder.ToTable("SalaryTransactions");
