...
namespace Generated
{
    public class DailyStatementUpsertsEntityConfiguration : IEntityTypeConfiguration<DailyStatementUpsertsEntity>
    {
        public void Configure(EntityTypeBuilder<DailyStatementUpsertsEntity> builder)
        {
            builder.ToTable("DailyStatementUpserts");
