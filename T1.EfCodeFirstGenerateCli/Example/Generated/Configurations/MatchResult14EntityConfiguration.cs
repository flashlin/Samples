...
namespace Generated
{
    public class MatchResult14EntityConfiguration : IEntityTypeConfiguration<MatchResult14Entity>
    {
        public void Configure(EntityTypeBuilder<MatchResult14Entity> builder)
        {
            builder.ToTable("MatchResult14");
