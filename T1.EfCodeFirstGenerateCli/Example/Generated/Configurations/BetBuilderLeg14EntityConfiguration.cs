...
namespace Generated
{
    public class BetBuilderLeg14EntityConfiguration : IEntityTypeConfiguration<BetBuilderLeg14Entity>
    {
        public void Configure(EntityTypeBuilder<BetBuilderLeg14Entity> builder)
        {
            builder.ToTable("BetBuilderLeg14");
