...
namespace Generated
{
    public class SpecialSalaryTransactionsEntityConfiguration : IEntityTypeConfiguration<SpecialSalaryTransactionsEntity>
    {
        public void Configure(EntityTypeBuilder<SpecialSalaryTransactionsEntity> builder)
        {
            builder.ToTable("SpecialSalaryTransactions");
