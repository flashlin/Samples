...
namespace Generated
{
    public class DailyStatementSumEntityConfiguration : IEntityTypeConfiguration<DailyStatementSumEntity>
    {
        public void Configure(EntityTypeBuilder<DailyStatementSumEntity> builder)
        {
            builder.ToTable("DailyStatementSum");
