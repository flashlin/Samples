...
namespace Generated
{
    public class bettrans14EntityConfiguration : IEntityTypeConfiguration<bettrans14Entity>
    {
        public void Configure(EntityTypeBuilder<bettrans14Entity> builder)
        {
            builder.ToTable("bettrans14");
