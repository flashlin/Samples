...
namespace Generated
{
    public class bettransmEntityConfiguration : IEntityTypeConfiguration<bettransmEntity>
    {
        public void Configure(EntityTypeBuilder<bettransmEntity> builder)
        {
            builder.ToTable("bettransm");
