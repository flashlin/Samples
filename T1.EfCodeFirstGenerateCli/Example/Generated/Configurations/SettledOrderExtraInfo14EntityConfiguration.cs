...
namespace Generated
{
    public class SettledOrderExtraInfo14EntityConfiguration : IEntityTypeConfiguration<SettledOrderExtraInfo14Entity>
    {
        public void Configure(EntityTypeBuilder<SettledOrderExtraInfo14Entity> builder)
        {
            builder.ToTable("SettledOrderExtraInfo14");
