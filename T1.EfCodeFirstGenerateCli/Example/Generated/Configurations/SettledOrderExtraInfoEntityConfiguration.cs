...
namespace Generated
{
    public class SettledOrderExtraInfoEntityConfiguration : IEntityTypeConfiguration<SettledOrderExtraInfoEntity>
    {
        public void Configure(EntityTypeBuilder<SettledOrderExtraInfoEntity> builder)
        {
            builder.ToTable("SettledOrderExtraInfo");
