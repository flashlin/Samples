...
namespace Generated
{
    public class SettledOrders14EntityConfiguration : IEntityTypeConfiguration<SettledOrders14Entity>
    {
        public void Configure(EntityTypeBuilder<SettledOrders14Entity> builder)
        {
            builder.ToTable("SettledOrders14");
