...
namespace Generated
{
    public class MatchResult_BufferTableEntityConfiguration : IEntityTypeConfiguration<MatchResult_BufferTableEntity>
    {
        public void Configure(EntityTypeBuilder<MatchResult_BufferTableEntity> builder)
        {
            builder.ToTable("MatchResult_BufferTable");
            ...
            builder.Property(x => x.ThirdPartyCode)
                .HasColumnType("nvarchar(50)")
                .HasMaxLength(50)
            ;

            builder.Property(x => x.IsSettleMultiple)
                .HasColumnType("bit")
            ;
