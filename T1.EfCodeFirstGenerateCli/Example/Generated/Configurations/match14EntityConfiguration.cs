...
namespace Generated
{
    public class match14EntityConfiguration : IEntityTypeConfiguration<match14Entity>
    {
        public void Configure(EntityTypeBuilder<match14Entity> builder)
        {
            builder.ToTable("match14");
