...
namespace Generated
{
    public class match_buffertableEntityConfiguration : IEntityTypeConfiguration<match_buffertableEntity>
    {
        public void Configure(EntityTypeBuilder<match_buffertableEntity> builder)
        {
            builder.ToTable("match_buffertable");
