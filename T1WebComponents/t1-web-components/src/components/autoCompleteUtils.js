...
export const findWordMatches = (text, searchWords) => {
...
export const highlightText = (searchText, text, highlightStart = '<span class="text-yellow-400 font-bold">', highlightEnd = '</span>') => {
    if (!searchText.trim()) {
        return text;
    }
    const normalizedText = normalizeText(text);
