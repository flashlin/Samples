...
# -v extractSelectSql -i D:\VDisk\MyGitHub\SQL -o \VDisk\Github\qa-pair\qa-files\synthetic\outputs
.\SqlSharp\bin\Debug\net8.0\SqlSharp.exe -v extractSelectSql -i D:\VDisk\MyGitHub\SQL -o $output_path -- DatabaseNamePathDeep 6
.\SqlSharp\bin\Debug\net8.0\SqlSharp.exe -v extractSelectSql -i D:\coredev_tw\DbProjects -o $output_path --DatabaseNamePathDeep 3