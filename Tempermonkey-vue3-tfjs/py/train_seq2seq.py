...
dec_outputs_2, dec_h2, dec_c2 = dec_layer_2(
    dec_outputs_1, initial_state=[enc_h2, enc_c2])
...
# seq2seq_2_layers = Model([enc_inputs, dec_inputs],
#                          dec_outputs_2, name="seq2seq_2_layers")
# seq2seq_2_layers.summary()

# plot_model(seq2seq_2_layers, to_file="output/2-layer_seq2seq.png",
