...
from ml.gnmt.attention import BahdanauAttention
...
class ResidualRecurrentDecoder(nn.Module):
    def __init__(self, vocab_size,
                 padding_idx,
                 hidden_size=128, num_layers=8, bias=True,
        ...
        if embedder is not None:
            ...
            self.embedder = nn.Embedding(vocab_size, hidden_size, padding_idx=padding_idx)
