...
namespace T1.GrpcProtoGenerator.Generators
{
    ...
    public class GrpcWrapperIncrementalGenerator : IIncrementalGenerator
    {
        ...
        private string GenerateWrapperSource(ProtoModel model)
        {
            ...
            sb.AppendLine("using System; using System.Collections.Generic; using System.Threading; using System.Threading.Tasks;");
            ...
            foreach (var svc in model.Services)
            {
                ...
                sb.AppendLine($"public class {wrapper} : {iface} {{ private readonly {grpcClient} _inner; public {wrapper}({grpcClient} inner) {{ _inner = inner; }}");
